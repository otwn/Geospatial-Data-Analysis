...
def get_latest_obs_df(filename):
    ...
    # fiter out the station outside of the Gulf of Mexico
    stations_df = stations_df.loc[(stations_df['LAT'] > 18.0) & (stations_df['LAT'] <= 31.0)\
               & (stations_df['LON'] < -87.0) & (stations_df['LON'] > -100.0)]
...
if __name__ == '__main__':
    ...
    save_df_to_csv(stations, 'latest_obs_gulfofmexico.csv')
